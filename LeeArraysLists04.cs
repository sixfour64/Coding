...
rm -r "/home/runner/codeBasics0102/obj/" && rm -r "/home/runner/codeBasics0102/bin/"
dotnet run --project "/home/runner/codeBasics0102/Coding01.csproj"

launch string in the .replit:
dotnet --info && dotnet --list-runtimes && dotnet --list-sdks && dotnet --version && dotnet run --project /home/runner/codeBasics0102/LeeArraysLists04.csproj
...
for (int i = 0; i < namesListOf.Count; i++)
{
    ...
    Console.Write($"\nindex# {i} "); Console.Write(namesListOf[i]);Console.WriteLine($"");
}
...
Console.WriteLine($"\nHow out works: {result}, {result + result}{Environment.NewLine}.");

Console.WriteLine($"Factorial(23) is: {Factorial(23)}");
...
{
    Console.WriteLine(((DictionaryEntry)kv).Key);
}
/* outputs:
mp3
txt
