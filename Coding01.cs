...
valid dotnet commands:
  dotnet build                        compiles without building;  run this from the top-level sln folder
  dotnet restore
  ...
  manuualy create a subfolder for Test		mkdir Test   under Coding01's folder
  ...
  dotnet watch run --project  Test/Test.csproj		run from the Test subfolder;  continuously watches for any file-save changes then re-runs the test suite automagically
